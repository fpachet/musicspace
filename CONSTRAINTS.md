...
- **Goal:** rotate sources around the listener over time.
...
- **Implementation note:** support ping-pong timing, easing curves, and optional pause at endpoints.
...
- **Initial examples:** angle + balance, product + radial limit backoff, open trio.
